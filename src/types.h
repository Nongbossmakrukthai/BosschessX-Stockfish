...
enum Value : int {
  ...
  PawnValueMg   = 213,   PawnValueEg   = 254,
  QueenValueMg  = 429,   QueenValueEg  = 496,
  BishopValueMg = 637,   BishopValueEg = 624,
  KnightValueMg = 847,   KnightValueEg = 896,
  RookValueMg   = 1398,  RookValueEg   = 1473,

  MidgameLimit  = 15846, EndgameLimit  = 3785,
};
